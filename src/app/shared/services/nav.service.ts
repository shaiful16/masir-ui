...
import {TitleComponent} from '../../elements/theme/title/title.component';
import {CollectionBannerComponent} from '../../elements/theme/collection-banner/collection-banner.component';
import {HomeSliderComponent} from '../../elements/theme/home-slider/home-slider.component';
import {CategoryComponent} from '../../elements/theme/category/category.component';
import {ServicesComponent} from '../../elements/theme/services/services.component';
import {ProductSliderComponent} from '../../elements/product/product-slider/product-slider.component';
import {BannersComponent} from '../../elements/product/banners/banners.component';
import {ProductTabsComponent} from '../../elements/product/product-tabs/product-tabs.component';
// tslint:disable
// Menu
...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		{title: 'About us', type: 'link', path: '/home',},
		{title: 'Shops', type: 'link', path: '/home'},
	];

	MENUITEMS_backup: Menu[] = [
		{title: 'home', type: 'sub', active: false, children: [
				{ path: '/home', title: 'Custom Home', type: 'link' },
		...
		{
			title: 'element', type: 'sub', active: false, children: [
				{ path: '/elements/theme/title', title: 'left-sidebar', type: 'link' },
				{ path: '/elements/theme/collection-banner', title: 'left-sidebar', type: 'link' },
				{ path: '/elements/theme/home-slider', title: 'left-sidebar', type: 'link' },
				{ path: '/elements/theme/category', title: 'left-sidebar', type: 'link' },
				{ path: '/elements/theme/services', title: 'left-sidebar', type: 'link' },
				{ path: '/elements/product/slider', title: 'left-sidebar', type: 'link' },
				{ path: '/elements/product/banners', title: 'left-sidebar', type: 'link' },
				{ path: '/elements/product/tabs', title: 'left-sidebar', type: 'link' },
				{ path: '/elements/product/multi-slider', title: 'left-sidebar', type: 'link' },
			]
		}
	];
