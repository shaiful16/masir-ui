...
const routes: Routes = [
  ...
  {path: 'shop', component: ShopComponent, loadChildren: () => import('./shop/shop.module').then(m => m.ShopModule)},
  ...
  {path: '**', /* Navigate to Home Page if not found any page*/ redirectTo: 'home/fashion', },
];
